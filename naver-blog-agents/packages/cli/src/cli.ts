...
import type { ContentRequest, ContentType, FinalContent } from '@geulto/core';
import { generateBlogContent, type OrchestratorOptions } from '@geulto/core';
import { getOutputPath, createLogger, serializeJSON } from '@geulto/core';
...
program
  ...
  .action(() => {
    ...
    const team = [
      { emoji: '📋', name: '민준 팀장', role: '기획자', age: 38, description: '차분하고 전략적인 베테랑 기획자' },
      { emoji: '🔍', name: '수빈', role: '리서처', age: 29, description: '꼼꼼한 팩트체커, 정보 수집의 달인' },
      { emoji: '📚', name: '현우 선생님', role: '정보성 작가', age: 45, description: '쉬운 설명의 달인, 교육적 접근' },
      { emoji: '✨', name: '지은 언니', role: '마케팅 작가', age: 33, description: '감성 스토리텔러, 트렌드 민감' },
      { emoji: '⭐', name: '태현', role: '제품리뷰 작가', age: 27, description: '솔직한 장단점 분석, 실용주의' },
      { emoji: '🍽️', name: '하린', role: '맛집리뷰 작가', age: 31, description: '오감 묘사 전문, 감성적 표현' },
      { emoji: '✏️', name: '서연 실장', role: '편집자', age: 40, description: '완벽주의자, 디테일의 여왕' },
      { emoji: '🎯', name: '준서', role: 'SEO 전문가', age: 35, description: '데이터 기반 사고, 키워드 마스터' },
      { emoji: '✈️', name: '유진', role: '여행 작가', age: 32, description: '감성 여행 블로거, 사진 중심 스토리텔링' },
      { emoji: '💻', name: '민석', role: '테크 작가', age: 35, description: 'IT 전문가, 스펙 비교의 달인' },
      { emoji: '🌸', name: '수아', role: '라이프스타일 작가', age: 28, description: '트렌디한 감성, 친근한 언니 같은 스타일' },
      { emoji: '👶', name: '예원맘', role: '육아 작가', age: 38, description: '경험 기반 육아 노하우, 따뜻한 조언' },
    ];
...
program
  ...
  .action(() => {
    ...
    const types = [
      { type: 'info', name: '정보성', writer: '현우 선생님', description: 'How-to, 가이드, 설명 콘텐츠', examples: ['~하는 방법', '~완벽 가이드', '~총정리'] },
      { type: 'marketing', name: '마케팅', writer: '지은 언니', description: '브랜드 콘텐츠, 협찬, 프로모션', examples: ['협찬 리뷰', '이벤트 소개', '브랜드 스토리'] },
      { type: 'review', name: '제품리뷰', writer: '태현', description: 'IT, 가전, 서비스 리뷰', examples: ['~솔직 후기', '~비교 분석', '~추천'] },
      { type: 'food', name: '맛집리뷰', writer: '하린', description: '맛집, 카페, 음식 리뷰', examples: ['맛집 추천', '카페 후기', '~먹방'] },
      { type: 'travel', name: '여행', writer: '유진', description: '국내/해외 여행 후기, 코스 추천', examples: ['여행 코스', '숙소 추천', '~여행기'] },
      { type: 'tech', name: '테크/IT', writer: '민석', description: 'IT, 전자기기, 앱/서비스 리뷰', examples: ['스펙 비교', '사용 후기', '~추천'] },
      { type: 'lifestyle', name: '라이프스타일', writer: '수아', description: '일상, 인테리어, 취미, 자기계발', examples: ['일상 브이로그', '인테리어 꿀팁', '~루틴'] },
      { type: 'parenting', name: '육아', writer: '예원맘', description: '육아 정보, 아이템 추천, 경험담', examples: ['육아템 추천', '아이 성장기', '~노하우'] },
    ];
